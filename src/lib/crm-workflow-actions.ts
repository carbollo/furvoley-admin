export const WORKFLOW_ACTION_OPTIONS = [
  ...
  { value: 'CREATE_INVITE_SIGNUP_LINK', label: 'Enlace de inscripción (invitación)' },
  { value: 'CREATE_SIGNUP_LINK', label: 'Enlace inscripción (socio)' },
  ...
  { value: 'GENERATE_RESPONSE_LINK', label: 'Generar enlace de respuesta (token)' },
  { value: 'APPLY_DISCOUNT_RULES', label: 'Aplicar descuentos y becas' },
  { value: 'RETRY_PAYMENT', label: 'Reintentar cobro fallido' },
  { value: 'SEND_OVERDUE_REPORT', label: 'Enviar informe de impagos' },
  { value: 'CALCULATE_PRORATED_REFUND', label: 'Calcular devolución prorrateada' },
  { value: 'CANCEL_SUBSCRIPTION', label: 'Cancelar suscripción' },
  { value: 'TRIGGER_WAITLIST_NOTIFY', label: 'Avisar lista de espera' },
