...
const TRIGGER_DESCRIPTIONS: Record<string, string> = {
  ...
  PAYMENT_FAILED: 'Un cobro de la pasarela falla.',
  ...
  SUBSCRIPTION_CREATED: 'Nueva cuota vinculada al socio en la pasarela.',
...
const ACTION_DESCRIPTIONS: Record<string, string> = {
  ...
  SEND_PAYMENT_LINK: 'Envía al socio su enlace de pago.',
  SEND_INVOICE_PDF_WHATSAPP: 'Adjunta o envía la factura en PDF por WhatsApp.',
  CREATE_SUBSCRIPTION: 'Crea la cuota en la pasarela con el plan configurado.',
  ...
  RETRY_PAYMENT: 'Reintenta un cobro fallido en la pasarela.',
  ...
  CANCEL_SUBSCRIPTION: 'Cancela la cuota del socio en la pasarela.',
